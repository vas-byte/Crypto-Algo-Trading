    ...
    def next(self):
        ...
        for crypto in self.datas:
            ...
            if can_buy:
                ...
                print(f"Buy signal for {crypto._name} - RSI: {self.rsi[crypto][0]}, EMA9: {self.ema9[crypto][0]}, EMA20: {self.ema20[crypto][0]}, SAR: {self.sar[crypto][0]}")
