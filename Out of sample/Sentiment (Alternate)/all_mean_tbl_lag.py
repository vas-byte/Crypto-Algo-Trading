...
def get_pandas_df(tickers):
    ...
    for ticker in tickers:
        ...
        # Load XRP text data
        dir = f"{ticker}/majority_vote_predictions_mean_lag.csv" # @param {"type":"string","placeholder":"./raw/labeled_tweets.csv"}
        ...
        price = price.merge(means[['signal', 'position_size']], left_index=True, right_index=True, how='left')
        print(means['signal'].value_counts())
